                    ...
                    <tbody>
                        @foreach ($contacts as $contact)
                            <tr>
                                ...
                                <td>
                                    @if ($contact->read == 0)
                                        <button type="button"
                                            ...
                                            class="change-status btn btn-primary btn-sm"><i class="fa fa-check"></i>
                                            Mark As Read</button>
                                    @else
                                ...
                                <td>
                                    <form action="{{ route('dashboard.contactForm.destroy', $contact->id) }}" method="post"
                                ...
                                <td>
                                    <form action="{{ route('dashboard.contactForm.note', $contact->id) }}" method="POST">
                                        @method('PUT')
                                        @csrf
